...
const conf = {
    ...
    // exportRoot: [path.resolve(path.join(projectRoot, 'i18n-raw', 'raw/doc')), createPublicFileName],
    exportRoot: [path.resolve(path.join(projectRoot, 'i18n-raw', 'raw/doc')),path.resolve(path.join(projectRoot, 'i18n-raw', 'origin')), createPublicFileName],
