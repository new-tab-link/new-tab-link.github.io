...
const anchorAllLinks = "diff-domain-links"

function Menu() {
    const { t } = useTranslation("doc/components/doc-parts/diff-domain-links/content")
    return (
        <>
    ...
    return (
        <AnchorAnimation anchor={anchorAllLinks}>
            <Box>
                ...
                <div>
                    <img className="autoImage" src={`/images/en/configuration-diff-domain-links.jpg`} />
                </div>
                <div>
                    {t("doc.description")}
                </div>
...
export const DocDiffDomainLink = {
    Menu, Doc
}